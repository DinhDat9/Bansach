...
namespace Toco
{
    public partial class Form0 : Form
    {
        ...
        private void btn_accept_Click(object sender, EventArgs e)
        {
            ...
            string connectionString = @"Data Source=DESKTOP-CI77JE4\SQLEXPRESS;Initial Catalog=DatDinh;Integrated Security=True;TrustServerCertificate=True";
        ...
        private void txtB_CustomerName_TextChanged(object sender, EventArgs e)
        {
